...
namespace SACA_Infra.Migrations
{
    ...
    [Migration("20250424054600_add_student_code")]
    partial class add_student_code
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SACA_Infra.Models.best_submission", b =>
                {
                    ...
                    b.Property<double?>("plagiarism_avg")
                        .HasColumnType("double");

                    b.Property<double?>("plagiarism_max")
                        .HasColumnType("double");

                    b.Property<string>("plagiarism_submission_id")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("SACA_Infra.Models.sys_account", b =>
                {
                    ...
                    b.Property<string>("student_code")
                        .HasColumnType("longtext")
                        .HasComment("Định danh sinh viên (tên + hai ký tự đầu của họ và tên đệm + mã số sinh viên)");
