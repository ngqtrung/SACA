...
namespace SACA_Infra.Migrations
{
    ...
    [Migration("20250417150641_add-column-invitation_email_sent-contest_particiipants")]
    partial class addcolumninvitation_email_sentcontest_particiipants
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SACA_Infra.Models.contest", b =>
                {
                    b.HasOne("SACA_Infra.Models.saca_file", "file")
                        .WithOne()
                        .HasForeignKey("SACA_Infra.Models.contest", "file_id");
